...
\- 🌸 Animate 类增加 [style](/plugin/in/animate/.md#animate-类#style-iuiinputdata) 属性，获取当前动画状态的样式

\- 🌸 Animate 类初始化 [target](/plugin/in/animate/.md#animate-类#target-ui-object) 参数支持普通对象。
...
\- [animation](/reference/UI/animation.md) 初始化 [event](/plugin/in/animate/.md#animate-类#event-ianimateevents) 监听未生效的问题
...
\- 增加 [config.selectAll](/plugin/in/text-editor/.md#texteditor-编辑器) 配置是否双击后自动全选文本
