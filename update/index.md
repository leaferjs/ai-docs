...
\- 🌸 [图形编辑器](/plugin/in/editor/index.md) 的 resize 控制点支持关联 [dragBounds](/reference/property/draggable.md#dragbounds-iboundsdata-parent)，用于限制拖动范围

\- 🌸 [视图控制](/plugin/in/view/index.md) 插件的 [zoom()](/plugin/in/view/zoom.md) 方法支持动画过渡参数

\- 🌸 增加资源库功能，可预加载，原始图片对象、画布对象可以直接作为元素填充内容
...
\- 🌸 Line 绘制多折线在 cornerRadius 较大是会出现毛刺
