...
Text.addAttr('version', '1.10.0', dataType)  //  [!code hl]
...
console.log((text as any).version) // 1.10.0

// set version

const text2 = new Text({ version: '1.10.0' } as any)

console.log((text2 as any).version) // 1.10.0
```
