...
Text.addAttr('version', '2.0.2', dataType)  //  [!code hl]
...
console.log((text as any).version) // 2.0.2

// set version

const text2 = new Text({ version: '2.0.2' } as any)

console.log((text2 as any).version) // 2.0.2
```
