...
Text.addAttr('version', '1.9.4', dataType)  //  [!code hl]
...
console.log((text as any).version) // 1.9.4

// set version

const text2 = new Text({ version: '1.9.4' } as any)

console.log((text2 as any).version) // 1.9.4
```
