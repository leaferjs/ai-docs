...
### animate ( keyframe?: [`IUIInputData`](/api/interfaces/IUIInputData.md) | [`IKeyframe`](/api/modules.md#ikeyframe)[] | [`IAnimation`](/reference/UI/animation.md), options?: [`ITranstion`](/api/modules.md#itransition) ) : [`Animate`](/plugin/in/animate/.md#animate-类)

执行动画方法，并返回 [动画实例](/plugin/in/animate/.md#animate-类)。
...
深入了解 [动画选项属性](/plugin/in/animate/.md#animate-类#动画选项-只读)。
...
### animate(): [`Animate`](/plugin/in/animate/.md#animate-类)
